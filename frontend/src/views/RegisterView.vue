  ...
  <div class="max-w-md mx-auto mt-12">
    <Card>
      ...
      <CardContent>
        ...
        <Button type="button" variant="full" size="lg" :disabled="loading"
          @click="handleGoogleRegister">
          <svg v-if="!loading" class="mr-2 h-4 w-4" viewBox="0 0 24 24">
...
async function handleGoogleRegister() {
  ...
  // Pas besoin de redirection ici car Supabase gère la redirection automatiquement
}
</script> 