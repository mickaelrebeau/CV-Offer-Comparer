...
export const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    meta: {
      ...
      title: 'Essai gratuit',
      description:
        'Analysez gratuitement la compatibilité entre votre CV et une offre d’emploi avec Talento.',
    },
  },
  {
    path: '/profile',
  ...
  },
  {
    ...
    meta: {
      ...
      title: 'Connexion',
      description:
        'Connectez-vous à Talento pour accéder à vos analyses CV ↔ offre et à votre historique.',
    },
  },
  {
    path: '/register',
    ...
    meta: {
      ...
      description:
        'Créez un compte Talento gratuit pour analyser vos candidatures et préparer vos entretiens.',
    },
  },
  {
    path: '/auth/callback',
  ...
  },
  {
    ...
    meta: {
      ...
      description:
        'Politique de confidentialité Talento : données, Gemini, PostHog et droits RGPD.',
    },
  },
]
